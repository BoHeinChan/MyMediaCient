            ...
            <div class="col-lg-8">
              ...
              <div class="about-right mb-90">
                ...
                <div class="social-share pt-30">
                  <i class="fa fa-eye" aria-hidden="true"> {{ viewCount }}</i>
                </div>
              </div>
              <!-- From -->
              <div class="row">
...
export default {
  ...
  methods: {
    async loadPost(id) {
      ...
      let post = await axios.post("http://127.0.0.1:8000/api/post_details", data);
      if (post.data.post.image == null) {
        post.data.post.image = "http://127.0.0.1:8000/default/default-image.jpg";
      } else {
        post.data.post.image =
          "http://127.0.0.1:8000/storage/images/" + post.data.post.image;
      }
  ...
  mounted() {
    ...
    axios.post("http://127.0.0.1:8000/api/action_log", data).then((res) => {
      this.viewCount = res.data.data.length;
    });
    this.postId = this.$route.params.key;
